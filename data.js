// THE KARDASHEV — Core Data Module
// Curated production (approx 2025 liquids) + major infrastructure

const PRODUCTION_DATA = [
  { country: "United States", code: "US", production: 21.1, lat: 31.0, lng: -100.0, type: "oil" },
  { country: "Saudi Arabia", code: "SA", production: 11.4, lat: 24.0, lng: 45.0, type: "oil" },
  { country: "Russia", code: "RU", production: 10.7, lat: 61.0, lng: 90.0, type: "oil" },
  { country: "Canada", code: "CA", production: 6.2, lat: 56.0, lng: -106.0, type: "oil" },
  { country: "Iran", code: "IR", production: 5.2, lat: 32.0, lng: 53.0, type: "oil" },
  { country: "Iraq", code: "IQ", production: 4.4, lat: 33.0, lng: 44.0, type: "oil" },
  { country: "China", code: "CN", production: 4.3, lat: 35.0, lng: 105.0, type: "oil" },
  { country: "United Arab Emirates", code: "AE", production: 4.2, lat: 24.0, lng: 54.0, type: "oil" },
  { country: "Brazil", code: "BR", production: 3.9, lat: -14.0, lng: -51.0, type: "oil" },
  { country: "Kuwait", code: "KW", production: 2.8, lat: 29.3, lng: 47.5, type: "oil" },
  { country: "Kazakhstan", code: "KZ", production: 2.1, lat: 48.0, lng: 68.0, type: "oil" },
  { country: "Norway", code: "NO", production: 2.0, lat: 62.0, lng: 10.0, type: "oil" },
  { country: "Qatar", code: "QA", production: 1.8, lat: 25.3, lng: 51.2, type: "oil" },
  { country: "Mexico", code: "MX", production: 1.8, lat: 23.0, lng: -102.0, type: "oil" },
  { country: "Nigeria", code: "NG", production: 1.8, lat: 9.0, lng: 8.0, type: "oil" }
];
...
const PIPELINES = [
  // Oil
  {
    ...
    coords: [[50.95, -104.05], [49.0, -104.0], [46.8, -101.5], [44.4, -97.5], [41.2, -97.0], [36.1, -95.9], [29.8, -95.0]]
  },
  {
    id: "dakota-access",
    ...
    countries: ["USA"],
    coords: [[47.5, -103.5], [46.8, -100.8], [45.5, -97.0], [43.5, -96.0], [41.5, -93.5], [40.5, -91.0]]
  },
  {
    id: "trans-mountain",
    ...
    countries: ["Canada"],
    coords: [[53.5, -114.1], [52.9, -117.5], [52.1, -119.3], [50.7, -121.0], [49.3, -122.8]]
  },
  {
    ...
    operator: "Enbridge",
    countries: ["Canada", "USA"],
    coords: [[53.5, -114.1], [53.5, -110.0], [52.0, -105.0], [49.9, -97.0], [48.0, -92.0], [46.5, -86.0], [42.5, -83.5]]
  },
  {
    id: "druzhba",
    ...
    coords: [[54.7, 52.3], [53.2, 44.0], [52.3, 37.6], [52.4, 32.0], [52.2, 24.0], [52.2, 21.0], [52.5, 14.4]]
  },
  {
    id: "btc",
    ...
    capacity: "1.2 million bpd",
    length: "1,768 km",
    operator: "BP / SOCAR consortium",
    countries: ["Azerbaijan", "Georgia", "Turkey"],
    coords: [[40.4, 49.9], [41.3, 47.5], [41.7, 44.8], [41.6, 41.6], [39.5, 36.8], [36.8, 35.3]]
  },
  {
    id: "east-west",
    ...
    coords: [[26.3, 50.1], [26.0, 47.0], [25.5, 44.0], [24.0, 41.0], [22.5, 38.5]]
  },
  {
    id: "sumed",
    name: "SUMED Pipeline",
  ...
  },
  {
    ...
    countries: ["USA"],
    coords: [[70.3, -148.5], [68.0, -149.0], [64.8, -147.7], [61.2, -149.9], [61.1, -146.3]]
  },
  // Gas (sample major)
  {
    id: "nord-stream",
  ...
  },
  {
    ...
    coords: [[60.0, 120.0], [55.0, 125.0], [50.0, 127.0], [45.0, 128.0], [40.0, 120.0]]
  },
  {
    id: "yamal-europe",
    name: "Yamal–Europe",
...
const REFINERIES = [
  ...
  { id: "paraguana", name: "Paraguaná Refinery Complex", capacity: "0.94 Mb/d", operator: "PDVSA", lat: 11.7, lng: -70.2, country: "Venezuela" },
  ...
  { id: "port-arthur", name: "Port Arthur", capacity: "0.63 Mb/d", operator: "Motiva / Shell", lat: 29.9, lng: -93.9, country: "USA" },
  { id: "rotterdam", name: "Rotterdam (Pernis)", capacity: "0.40 Mb/d", operator: "Shell", lat: 51.9, lng: 4.3, country: "Netherlands" },
  { id: "singapore", name: "Singapore Refining Co.", capacity: "0.29 Mb/d", operator: "SRC / Chevron", lat: 1.3, lng: 103.7, country: "Singapore" }
];
...
const FIELDS = [
  ...
  { id: "cantarell", name: "Cantarell", production: "~0.15 Mb/d (declining)", operator: "Pemex", lat: 19.5, lng: -92.0, country: "Mexico" },
  ...
  { id: "pre-salt", name: "Brazilian Pre-Salt", production: "~2.5+ Mb/d", operator: "Petrobras + partners", lat: -24.0, lng: -42.0, country: "Brazil" }
];
...
// Sample historical production for charts (illustrative)
